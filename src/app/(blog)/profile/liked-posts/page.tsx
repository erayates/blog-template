  ...
  return (
    <main className='col-span-9 pt-12 font-primary'>
      ...
      <section className='user-likeds-posts-body ' >
        <div className='user-liked-posts-search mb-10 '>
          <form>
        ...
        <div className='user-liked-posts-content grid grid-cols-1 lg:grid-cols-2 gap-12'>
          <PostCard />
          <PostCard />
        </div>
        <div className="flex items-center justify-between  my-16" aria-label="Table navigation">
          <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span className="font-semibold text-gray-900 dark:text-white">1-10</span> of <span class="font-semibold text-gray-900 dark:text-white">1000</span></span>
