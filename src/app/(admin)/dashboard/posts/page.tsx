    ...
    return (
        <main className="ml-64 top-4 p-16 relative z-50 ">
            <section className="col-span-2">
                <Breadcrumb />
                <h1 className="text-[48px] font-primary font-semibold leading-10">Posts</h1>
                <p className="text-black/50">Manage your posts</p>
            </section>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        <tr>
                                            ...
                                            <td className="px-4 py-4  whitespace-nowrap">
                                                <img className="object-cover w-16 h-16 rounded-2xl" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                                            </td>
                                            ...
                                            <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 ">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore ab vel dignissimos vitae libero, debitis, dolorum veritatis eius laudantium ducimus deserunt ut, mollitia dolor nesciunt modi vero atque! Debitis, consequuntur!</td>
